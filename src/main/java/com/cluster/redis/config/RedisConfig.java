...
public class RedisConfig {
    ...
    public JedisConnectionFactory getJedisConnectionFactory() {
        ...
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30001));
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30002));
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30003));
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30004));
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30005));
        clusterConfig.addClusterNode(new RedisNode("127.0.0.1", 30006));
